...
export default function Perfil({
  ...
  return (
    <section
      className={`bg-white shadow-sm rounded-xl p-6 border border-gray-200 hover:shadow-md transition-shadow ${className}`}
    >
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <button
          ...
          className="w-full max-w-[200px] py-2 px-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors duration-200"
        >
        ...
        <div className="w-full space-y-2">
          ...
          <div className="flex items-center justify-center gap-2 text-sm">
            ...
            <span className="text-gray-600">Membro desde: {dataEntrada}</span>
          </div>
        </div>
